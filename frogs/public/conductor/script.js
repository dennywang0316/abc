...
//from the first moment, it is connected to socket
...
socket.on("all-frogs", function(data){//in the beginning,checking everybody
    console.log(data);
...
socket.on("new-frog",function(frog){//check if there is new frog coming in
    console.log(frog);
    addFrog(frog.id,frog.frogIdx);
})
