...
function requestGPS() {
  ...
  navigator.permissions.query({ name: "geolocation" }).then((result) => {
    ...
    // Safari (and some embedded browsers) do not yet support navigator.permissions.
    // Fallback straight to requesting GPS so at least we can attempt to get a lock.
    navigator.geolocation.watchPosition(handleNewPosition, function(error){
      console.log("ERRROR GPS:", error)
    }, GPS_options);
    GPS_GRANTED = true;
